...
/**
 * @function
 * @description Applies a 20% discout to the price passed in.
 * 
 * This function is implemented using the 'arrow function' style.
 * <pre>
 * function ApplyDiscount_af(price) { return price * .80; }
 * </pre>
 * @param {number} price 
 * @returns {number}
 */
